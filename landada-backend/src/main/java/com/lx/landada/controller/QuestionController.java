...
import com.lx.landada.model.dto.question.*;
...
import com.lx.landada.scoring.strategy.ScoringStrategyContext;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        // 查询app是否创建过题目
        Question oldQuestion = questionService.getOne(
                Wrappers.lambdaQuery(Question.class)
                        .eq(Question::getAppId, appId));
        ThrowUtils.throwIf(oldQuestion != null, ErrorCode.OPERATION_ERROR, "该应用已创建过题目");
