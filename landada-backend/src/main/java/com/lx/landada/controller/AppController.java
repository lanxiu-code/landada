...
import com.lx.landada.model.dto.app.AppEditRequest;
import com.lx.landada.model.dto.app.AppQueryRequest;
import com.lx.landada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<AppVO> getAppVOById(long id, HttpServletRequest request) {
        ...
        // 查询缓存
        String json = caffeine.getIfPresent(String.valueOf(id));
        // 是否存在
        if(StrUtil.isNotBlank(json) || "empty".equals(json)){
            AppVO appVO = null;
            if(!"empty".equals(json)){
                appVO = JSONUtil.toBean(json, AppVO.class);
            }
        ...
        if(app==null){
            // 防止缓存穿透,空键缓存道布隆过滤器
            caffeine.put(String.valueOf(id),"empty");
            return ResultUtils.success(null);
        }
        AppVO newAppVO = appService.getAppVO(app, request);
        // 更新缓存
        caffeine.put(newAppVO.getId().toString(), JSONUtil.toJsonStr(newAppVO));
        return ResultUtils.success(newAppVO);
    }
    ...
    public BaseResponse<Page<AppVO>> listAppVOByPage(@RequestBody AppQueryRequest appQueryRequest,
        ...
        // 查询数据库
        Page<App> appPage = appService.page(new Page<>(current, size),
                appService.getQueryWrapperVO(appQueryRequest));
        // 获取封装类
    ...
    * */
    ...
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        ...
        return appService.doAppReview(reviewRequest, request);
    }
    // endregion
}
